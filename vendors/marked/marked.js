...
const marked = (() => {
	...
	var exports_defaults = _getDefaults();
	...
	const findClosingBracket = (str, b) => {
	...
	class _Tokenizer {
		constructor(options) {
			this.options = options || exports_defaults;
//			this.rules; // set by the lexer
//			this.lexer; // set by the lexer
		}
		space(src) {
	...
	class _Renderer {
		constructor(options) {
			this.options = options || exports_defaults;
//			this.parser = null; // set by the parser
		}
		space() {
			return '';
		}
...
/*
	 ...
	 * Gets the original marked default options.
	 * /
	marked.defaults = exports_defaults;
	/**
	 * Run callback for every token
	 * /
...
*/
		parse: (src, opt) => markedInstance.parse(src, opt),
/*
		/**
